...
// other OpenAI endpoints. See the Twilio blog for a full walkthrough【501579161073898†L990-L1051】.
...
app.post('/', async (req, res) => {
  try {
    ...
    // Verify the webhook signature using the OpenAI SDK
    const event = await client.webhooks.unwrap(rawBody, req.headers, WEBHOOK_SECRET);
