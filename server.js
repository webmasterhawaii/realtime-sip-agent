...
// Additional tools can be defined here.  Only local function tools are
// included in this implementation.  Built‑in web search is not supported in
// realtime calls (it is only available via the Responses and Chat
// Completions APIs【969108787484327†screenshot】), so we omit it here.  See
...
// configuration blocks have been removed.  Only local function tools are
// supported now.
